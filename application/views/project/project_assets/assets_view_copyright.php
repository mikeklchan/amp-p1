            ...
            <table class="navigation projectlist">
              <tbody>
                <tr>
                  ...
                  <td class="title"><a href="index.php/assets/assets_view"><span>无形资产</span></a><i class="fa_angle_right fa"><!--[if lte IE 7]><![endif]--></i><span>著作权</span></td>
            ...
            <table class="navigation project_tab">
              <tbody>
                <tr>
                  ...
                  <td class="location active"><span>著作权</span></td>
                  <td class="empty"></td>
                </tr>
              </tbody>
            </table>
              ...
              <table cellspacing="1">
                <tbody>
                  ...
                  <!--第一个class:No:是必须,后面的name/type/area/state等等是非必须,可以根据意义自由定义,作将来调整样式的需要.-->
                    ...
                    <th class="attr"><span>著作权名称</span></th>
                    <th class="attr"><span>著作权人</span></th>
                    <th class="attr"><span>权利取得方式</span></th>
                    <th class="attr"><span>权利范围</span></th>
                  ...
                  <tr>
                    ...
                    <td class="attr"><span><a href="index.php/assets/assets_copyright/<?php echo $item['COPYRIGHT_ID']?>"><?php echo $item['AMP_CODE']?></a></span></td>
                    <td class="attr"><?php echo $item['CERT_CODE']?></td>
                    <td class="attr"><?php echo $item['RIGHTS_NAME']?></td>
                    <td class="attr"><?php echo $item['RIGHTS_PERSON']?></td>
                    <td class="attr"><?php echo $item['RIGHTS_FROM']?></td>
                    <td class="attr"><?php echo $item['RIGHTS_AREA']?></td>

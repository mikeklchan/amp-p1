...
<!--     navigation     -->
		...
		<form  method="post" action="index.php/upload_pic/get_cell"enctype="multipart/form-data">
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="attr"><span>选择楼层</span></td>
                    <td class="value"><span><select name='floor[]' multiple="multiple" style="width:187px">
                                 <option value="">——请选择——</option>
                                                                       
                                      <?php foreach($floor_item as $v2):?>
                                     <option value="<?php echo $v2['FLOOR_ID'];?>"><?php echo $v2['FLOOR'];?></option>
                                      <?php endforeach?>

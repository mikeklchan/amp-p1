...
<!--     navigation     -->
		...
		<form  method="post" action="index.php/upload_pic/get_floor"enctype="multipart/form-data">
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="attr"><span>选择建筑</span></td>
                    <td class="value"><span><select name='building[]' multiple="multiple" style="width:187px">
                                 <option value="">——请选择——</option>
                                                                       
                                      <?php foreach($building_item as $v2):?>
                                     <option value="<?php echo $v2['BUILDING_ID'];?>"><?php echo $v2['BUILDING'];?></option>
                                      <?php endforeach?>
                                  
                                   
                                         </span></td><input class="btn grey" type="submit" value="下一步">
                  </tr>
				  <tr>
				  <td><br/></td>
				  </tr>

...
<form action="index.php/project_info_maintain/add_data" method="post">
              ...
              <table>
                <tbody>                
                  ...
                  <tr>
                    ...
                    <td class="value"><span><input type="text" name="PROJECT" ></span></td>
                  </tr>
                  
				  <tr>
                    <td class="dot"><i class="fa_arrow_right fa"><!--[if IE 7]><![endif]--></i></td>
                    <td class="attr"><span>公安局备案地址</span></td>
                    <td class="value"><span><input type="text" name="PSB_ADDRESS"></span></td>
                  </tr>
                  <tr>
                    <td class="dot"><i class="fa_arrow_right fa"><!--[if lte IE 7]><![endif]--></i></td>
                    <td class="attr"><span>地域</span></td>
                    <td class="value"><span><input type="text" name="DISTRICT" ></span></td>
                  </tr>
                  </tbody>
                </table>
              <div class="clear"></div>
